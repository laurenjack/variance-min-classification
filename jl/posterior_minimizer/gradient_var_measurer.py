...
from jl.posterior_minimizer.regularizer import DirectReg, L1, reg_grad, variance_grad
from jl.posterior_minimizer.variance import manual_grad_calc, grad_at_zero
