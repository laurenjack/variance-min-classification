...
Training outputs are organized by timestamp in `output/resnet18/MM-DD-HHmm/`:
...
Plots are auto-generated by `lambda_download.sh` and saved alongside metrics in the run folder.
