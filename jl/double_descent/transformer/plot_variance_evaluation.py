...
Produces a single figure showing test loss, Jensen Gap (variance), and
implied or oracle-based bias.

Usage:
    python -m jl.double_descent.transformer.plot_variance_evaluation \
        ./data/transformer_variance/03-01-1010/evaluation.jsonl \
        --output-dir ./data/transformer_variance/03-01-1010
"""
...
def plot_evaluation(eval_path: str, output_dir: str) -> None:
    ...
    Supports two formats:
      - Label-only: mean_test_loss, mean_jensen_gap → plots test loss,
        Jensen gap, entropy+bias.
      - Distributional (with M2M100 oracle): mean_test_loss, entropy, bias,
        variance → plots all four terms.
    """
